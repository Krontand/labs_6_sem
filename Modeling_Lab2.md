...
Задается шаг по времени и количество узлов (ну или что-нибудь в этом роде)

Я не уверен, нужна ли возможность менять все константы из интерфейса, но у меня он игрался со значением Rk.
* Rk = 0.2 Ом
* Lk = 60e-6 Гн
* Ck = 150e-6 Ф
* Uc0 = 3000 В
* I0 = 0 .. 2 А (т.е. произвольно задать из этого интервала)
* R = 0.35 см (не путать с Rk - там сопротивление, а это радиус трубки, он фигурирует в верхней границе интеграла)
* p0 = 0.5 атм
